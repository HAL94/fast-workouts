"""schedule_restructure_fields

Revision ID: 0c33d5d10c05
Revises: 6bfbde84817e
Create Date: 2025-08-08 13:43:26.008076
...
def upgrade() -> None:
    ...
    op.add_column('workout_plan_schedules', sa.Column('reminder_send_status', sa.String(), nullable=False))
...
def downgrade() -> None:
    ...
    op.drop_column('workout_plan_schedules', 'reminder_send_status')
    # ### end Alembic commands ###
